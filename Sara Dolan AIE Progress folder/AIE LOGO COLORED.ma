...
//Name: AIE LOGO COLORED.ma
//Last modified: Fri, May 31, 2013 04:09:30 PM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.5111768977683164 5.1939594564273559 22.63975239449433 ;
	setAttr ".r" -type "double3" -12.338352729599457 0.19999999999725748 -1.4287735028908086e-016 ;
	setAttr ".rp" -type "double3" -7.7299278089526524e-015 -6.2172489379008766e-015 
		0 ;
	setAttr ".rpt" -type "double3" 3.7558872951177825e-015 2.2145485922143417e-016 6.8310631418484767e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 19.154704646810128;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" 3.1288343558282228 1.3343558282208583 0 ;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" 4.3021472392638067 0.94325153374233117 0 ;
...
createNode transform -n "group";
	setAttr ".rp" -type "double3" 6.7315783500671387 1.3462559878826139 0 ;
	setAttr ".sp" -type "double3" 6.7315783500671387 1.3462559878826139 0 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace1";
	...
	setAttr ".ix" -type "matrix" 1.9301458004445529 1.9116621969547851 0 0 -0.45474579138987864 0.45914266700424206 0 0
	...
	setAttr ".lt" -type "double3" -3.5904297956299933e-016 -1.3084361458209513e-016 
		0.39482202270097205 ;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" 2.2100926425641534 1.6749403971311425 -0.5 ;
...
createNode hyperLayout -n "hyperLayout1";
	...
	setAttr ".hyp[1].x" 225.9844970703125;
	setAttr ".hyp[1].y" -42909.515625;
...
createNode animCurveTL -n "polySurface2_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  240 -1.3511410885739903 360 0 720 0;
...
createNode animCurveTU -n "polySurface3_scaleX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  420 0.00045223545149612938 532 0.98726497362353893
		 540 1 720 1;
...
createNode file -n "file3";
	setAttr ".ftn" -type "string" "C:/Users/student/Desktop/AIE LOGO COLOR.jpg";
